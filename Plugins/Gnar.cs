...
namespace Plugins
{
    public class Gnar : Helper
    {
        ...
        public static void Farm()
        {
            ...
            bool Pasive = myHero.HasBuff("Gnarpassivecharged");
            ...
            if (!Pasive)
            {
                ...
                if (myHero.Level > 10)
                {
                    ...
                    {
                        if (Pasive || myHero.GetBuffCount("Gnarpassivestack") == 4 && !Q.IsReady() | !W.IsReady() | !E.IsReady())
                        {
                            R.Cast();
                        }
                    }
        ...
        public static void Combo()
        {
            ...
            bool Pasive = myHero.HasBuff("Gnarpassivecharged");
            var Stacks = myHero.GetBuffCount("Gnarpassivestack");
            ...
            bool StacksBuff = myHero.HasBuff("Gnarpassivestack");
